...
public class SimulatorAction extends AbstractAction {
	 ...
	 *            https://docs.oracle.com/javase/8/docs/api/index.html for
	 *            details. Examples include: "control DELETE" or "alt shift X"
	 */
	...
	public SimulatorAction(Object name, String tooltip, Integer mnemonic,
			Runnable callback) {
		super("" + name);
		putValue(Action.SHORT_DESCRIPTION, tooltip);
		putValue(Action.MNEMONIC_KEY, mnemonic);
